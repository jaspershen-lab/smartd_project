...
# info <-
#   info %>%
#   dplyr::filter(ID %in% temp_data$subject_id)
#
# info <-
#   info[match(unique(temp_data$subject_id), info$ID), ]
#
# info$ID == unique(temp_data$subject_id)
#
# ## we have
# colnames(info)
#
...
#
# met_data <-
#   lapply(unique(sample_info$subject_id), function(id) {
...
#
# colnames(met_data) <- unique(sample_info$subject_id)
#
# #------------------------------------------------------------------------------
# ## due date
# due_data <-
...
# sample_info <- readr::read_csv("sample_information.csv")
# info$ID <-
#   info$ID %>%
#   stringr::str_replace("sf", "") %>%
#   paste("SF", ., sep = "")
...
# info <-
#   info %>%
#   dplyr::filter(ID %in% sample_info$subject_id)
#
# ## ID:participant ID
