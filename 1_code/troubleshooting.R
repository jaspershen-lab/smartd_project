...
metflow2::showPeak(object = peak_data_pos,
                   peak.index = 1,
                   alpha = 0)
metflow2::showPeak(object = peak_data_pos,
                   peak.index = 2,
...
data1 <- data.frame(mz = is_table_pos$mz,
                    rt = 1,
...
match_result_pos <- masstools::sxtMTmatch(
...
metflow2::showPeak(object = peak_data_neg,
                   peak.index = 3,
                   alpha = 0)
metflow2::showPeak(object = peak_data_neg,
                   peak.index = 4,
...
result <-
  masstools::sxtMTmatch(
    data1 = as.matrix(pos1[, -1]),
    data2 = as.matrix(pos2[, -1]),
    mz.tol = 25,
    rt.tol = 1000000000000000000,
    rt.error.type = "abs"
  )
