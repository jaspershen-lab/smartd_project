...
ggsave(plot, filename = "annotation_level_distributation.pdf", width = 7, height = 7)
...
####sample info
load("../sample_information/sample_information")
...
birth_wt[birth_wt == "3015 / 3170" & !is.na(birth_wt)] <- 2315+2190
