...
ggsave(pca_data_quality_plot, 
       filename = "pca_data_quality_plot_dark.png", 
...
ggsave(pca_pos_neg_data_quality_plot, 
       filename = "pca_pos_neg_data_quality_plot_dark.png", 
       width = 7, height = 7,
       bg = "transparent")
...
ggsave(pca_pos_neg_plot, filename = "pca_pos_neg_plot.png", 
       width = 7, height = 7, bg = "transparent")
